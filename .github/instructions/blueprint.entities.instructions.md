...
- **`entity/`** - Base entity classes (inherit `PentairPoolEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, PentairPoolEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import PentairPoolEntity`
