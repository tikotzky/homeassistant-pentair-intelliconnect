...
- `entity/` — Base entity class (`PentairPoolEntity`)
...
- Entity MRO: `(PlatformEntity, PentairPoolEntity)` — order matters
...
- Debug level: `custom_components.pentair_pool: debug` in `config/configuration.yaml`
