...
- Create new sensor file in `custom_components/pentair_pool/sensor/`
- Inherit from `PentairPoolEntity` and `SensorEntity`
...
class PentairPool[SensorName]Sensor(
    PentairPoolEntity,
    SensorEntity,
):
...
- Entity: `custom_components/pentair_pool/sensor/[sensor_name].py`
- Platform: `custom_components/pentair_pool/sensor/__init__.py`
- Translations: `custom_components/pentair_pool/translations/*.json`
