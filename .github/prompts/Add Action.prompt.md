...
**File:** `custom_components/pentair_pool/services.yaml`
...
**File:** `custom_components/pentair_pool/__init__.py`
...
**File:** `custom_components/pentair_pool/const.py`
...
3. Find service action: `pentair_pool.[action_name]`
...
- **Domain:** `pentair_pool`
- **Service actions directory:** `custom_components/pentair_pool/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/pentair_pool/services.yaml` (legacy filename)
- **Icons:** `custom_components/pentair_pool/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/pentair_pool/translations/*.json` under `services` key (legacy)
