...
- Inherit from `PentairPoolEntity` and platform base class
...
- Entity: `custom_components/pentair_pool/[platform]/[entity_name].py`
- Platform: `custom_components/pentair_pool/[platform]/__init__.py`
