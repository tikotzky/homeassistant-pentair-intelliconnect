...
class PentairPoolApiClientCommunicationError(
    PentairPoolApiClientError,
):
    """Exception to indicate a communication error with the API."""


class PentairPoolApiClientAuthenticationError(
    PentairPoolApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        PentairPoolApiClientAuthenticationError: For 401/403 errors.
...
class PentairPoolApiClient:
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            PentairPoolApiClientAuthenticationError: If authentication fails.
            PentairPoolApiClientCommunicationError: If communication fails.
            PentairPoolApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise PentairPoolApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise PentairPoolApiClientError(
                msg,
            ) from exception
