"""
Custom integration to integrate pentair_pool with Home Assistant.
...
https://github.com/tikotzky/homeassistant-pentair-pool
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = PentairPoolData(
        client=client,
