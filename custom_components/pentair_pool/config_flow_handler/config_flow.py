...
from custom_components.pentair_pool.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.pentair_pool.config_flow_handler.validators import validate_credentials
...
ERROR_MAP = {
    "PentairPoolApiClientAuthenticationError": "auth",
    "PentairPoolApiClientCommunicationError": "connection",
}


class PentairPoolConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for pentair_pool.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.pentair_pool.config_flow_handler.options_flow import (  # noqa: PLC0415
            PentairPoolOptionsFlow,
        )

        return PentairPoolOptionsFlow()
