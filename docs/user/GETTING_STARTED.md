...
1. Download the latest release from the [releases page](https://github.com/tikotzky/homeassistant-pentair-pool/releases)
2. Extract the `pentair_pool` folder from the archive
3. Copy it to `custom_components/pentair_pool/` in your Home Assistant configuration directory
...
- Report issues at [GitHub Issues](https://github.com/tikotzky/homeassistant-pentair-pool/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/tikotzky/homeassistant-pentair-pool/discussions)
