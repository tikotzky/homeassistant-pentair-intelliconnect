...
- `custom_components/pentair_pool/` - Main integration code
...
- Integration logs: `custom_components.pentair_pool: debug` in `config/configuration.yaml`
...
- Inherit from platform base + `PentairPoolEntity`
...
- `tests/` mirrors `custom_components/pentair_pool/` structure
